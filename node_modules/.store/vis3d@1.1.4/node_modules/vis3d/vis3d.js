import { polygon, area, point, booleanPointInPolygon, featureCollection, center } from '@turf/turf';
import { map, tileLayer, latLng, latLngBounds, rectangle } from 'leaflet';
import 'leaflet/dist/leaflet.css';
import axios from 'axios';
import { graphic as graphic$1, matrix, init, registerCoordinateSystem, registerAction, extendComponentModel, extendComponentView } from 'echarts';
...
var CreateLabel = /*#__PURE__*/function (_BasePlot) {
  ...
  _createClass(CreateLabel, [{
    ...
    key: "getPositions",
    value: function getPositions(isWgs84) {
      return isWgs84 ? util$1.cartesianToLnglat(this.position) : this.position;
    }
  }, {
    key: "startEdit",
    value: function startEdit(callback) {
...
var CreatePolyline = /*#__PURE__*/function (_BasePlot) {
  ...
  _createClass(CreatePolyline, [{
    ...
    value: function createByPositions(lnglatArr, callback) {
      ...
      if (!lnglatArr || lnglatArr.length < 1) return;
      this.state = "startCreate";
      var positions = lnglatArr[0] instanceof Cesium.Cartesian3 ? lnglatArr : util.lnglatsToCartesians(lnglatArr);
      if (!positions) return;
